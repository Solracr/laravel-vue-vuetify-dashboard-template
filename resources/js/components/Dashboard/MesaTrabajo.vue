      ...
      <table class="table table-striped">
        ...
        <tbody>
            <tr v-for="row in allData" :key="row">
                ...
                <td></td>                
                <td><button type="button" name="edit" class="btn btn-primary btn-xs edit" @click="fetchData(row.archivo)">Ver PDF</button></td>              
              </tr>
        </tbody>
      </table>
...
<script>
    ...
    export default {
        ...
        fetchData: function(qr) {                              
            ...
            console.log('a cargar '+this.archivoPDF);
        },
        search: function() {
          var results = [];
